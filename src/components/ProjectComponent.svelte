...
<div
	class="dark:bg-stone-800 bg-white dark:text-white rounded-xl bg-cover flex my-1 items-center overflow-scroll"
>
	<img
		src={project.icon}
		alt="project icon"
	...
	<div class="p-1 md:p-2">
		<p class="ml-4 font-brand text-lg md:text-xl lg:text-2xl">{project.title}</p>
