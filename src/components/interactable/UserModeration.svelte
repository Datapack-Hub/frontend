  ...
  <div class="ms:max-w-lg flex max-w-full justify-center md:justify-start">
    <div class="mt-4 w-full rounded-xl bg-red-500/25 p-2">
      ...
      <button
        ...
        on:click="{() => notifDialog.open()}">
        <img src="/icons/message.svg" alt="msg" class="h-8 p-1 dark:invert" />
        Send a Notification
      </button>
      <a
        ...
        <img src="/icons/settings.svg" alt="ban" class="h-8 p-1 dark:invert" />
