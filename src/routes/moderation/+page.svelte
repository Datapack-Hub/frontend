  ...
  <div
    ...
    <div class="mb-2 flex space-x-2">
      ...
      <a href="/moderation/console"
        ><button
          class="button-base bg-stone-800"
          >Open console</button
        ></a>
    </div>

    {#await loadStuff()}
    <p class="font-brand dark:text-white p-2 ">Loading...</p>
    {:then}
    {#if activePage == "publish_queue"}
      <div use:autoAnimate class="text-center align-middle md:text-start bg-pearl-lusta-200 p-3 rounded-xl dark:bg-pearl-lusta-100/10">
