<script lang="ts">
    ...
    let rolesJson: [{ name: string; color: string; time: number, verified:boolean, permissions:string[] }];
  ...
  <main
    ...
    <div class="h-screen w-full flex-col md:flex-row md:items-start md:pt-5">
      ...
      <p class="font-brand dark:text-white">This page is meant for easy viewing and modifying of roles.</p>
      <br />
