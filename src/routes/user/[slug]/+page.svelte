...
<main
  class="flex flex-col lg:flex-row w-full items-center bg-pearl-lusta-100 px-8 transition-all dark:bg-stone-900 md:items-start md:px-16 md:pt-32 lg:px-24">
