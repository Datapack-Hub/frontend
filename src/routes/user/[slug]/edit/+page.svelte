...
<main
  ...
  <div
    ...
    <div class="text-center align-middle md:text-start">
      ...
      <input
        class="h-10 rounded-md bg-gray-200 p-2 text-lg text-slate-950 dark:bg-stone-800 dark:text-white"
      ...
      <textarea
        class="h-96 w-1/2 resize-none rounded-md bg-gray-200 p-2 text-lg text-slate-950 dark:bg-stone-800 dark:text-white"
        maxlength="500"
