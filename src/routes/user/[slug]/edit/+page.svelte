...
<main
  ...
  <div
    ...
    <h1
      class="mt-8 pb-10 text-center text-5xl font-bold text-pearl-lusta-950 dark:text-white md:text-start md:text-4xl lg:text-5xl">
    ...
    <div class="text-center align-middle md:text-start">
      ...
      <textarea
        class="h-96 w-1/2 resize-none rounded-md bg-pearl-lusta-200 p-2 text-lg text-pearl-lusta-950 dark:bg-stone-800 dark:text-white"
        maxlength="500"
