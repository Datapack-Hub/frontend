...
<main
  ...
  <div
    ...
    <h1
      class="mt-8 pb-10 text-center font-brand text-5xl font-bold text-pearl-lusta-900 dark:text-white md:text-start md:text-4xl lg:text-5xl">
    ...
    <div class="text-center align-middle md:text-start">
      ...
      <input
        class="h-10 rounded-md bg-pearl-lusta-200 p-2 font-brand text-lg dark:bg-stone-800 text-pearl-lusta-900 dark:text-white"
      ...
      <textarea
        class="h-40 w-80 resize-none rounded-md bg-pearl-lusta-200 p-2 font-brand text-lg dark:bg-stone-800 text-pearl-lusta-900 dark:text-white"
        maxlength="500"
