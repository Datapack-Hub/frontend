...
<main
  id="main-content"
  class="flex h-screen w-full flex-col items-center justify-center bg-slate-50 transition-colors dark:bg-zinc-900 md:flex-row md:justify-start px-4 sm:px-8 md:px-16 lg:px-24">
  <p
