...
<main
  ...
  <div
    ...
    <div class="flex-grow">
      <h1
        ...
        <span class="mx-3 px-2 rounded-full bg-stone-700 text-stone-500 font-brand font-bold text-xl">Draft</span>
        {/if}
      </h1>
      <h2
  ...
  {#if activePage == "description"}
    <div
      ...
      <p class="prose prose-stone font-brand leading-tight dark:prose-invert w-full">
