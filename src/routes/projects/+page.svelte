...
<main class="dark:bg-stone-900 bg-new-white transition-all px-4 lg:px-32 xl:px-64">
    <div class="items-center md:items-start md:flex-row w-full h-screen pt-16 md:pt-16 overflow-auto">
        {#await load()}
        ...
        <div class="flex items-center md-5">
            ...
            <a href="?sort=trending" class="mr-2 text-orange-500 rounded-lg p-1 font-semibold bg-opacity-0 bg-orange-500 hover:bg-opacity-20">Trending</a>
        </div>
        <div class="flex flex-col items-center w-full pu-5">
