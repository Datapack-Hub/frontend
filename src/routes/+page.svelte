...
<main
  id="main-content" class="bg-slate-50 transition-all dark:bg-stone-900 h-full">
  <div class="pt-0 md:pt-20"></div>
  <div class="moderation mx-0 sm:mx-8 md:mx-16 lg:mx-24 dark:text-white p-2 rounded-lg">
  ...
  <div class="flex h-screen md:h-[75vh] w-full flex-col items-center justify-start overflow-visible px-0 sm:px-8 md:flex-row md:justify-between md:px-16 lg:px-24">
    <div class="w-2/3 md:w-3/5 lg:w-2/5">
      <div class="relative mb-4 h-36 w-full md:mb-0 {visible
          ? 'visible'
          : 'invisible'}">
        <h1
          id="indexText1" class="split-text absolute left-1/2 inline-block w-full -translate-x-1/2 overflow-y-hidden text-center text-5xl font-bold sm:text-6xl md:left-0 md:w-auto md:translate-x-0 md:text-left md:text-7xl xl:text-8xl">
          <span class="letters inline-block text-dph-orange">Explore</span>
        </h1>
        <h1
          id="indexText2" class="split-text absolute left-1/2 inline-block w-full -translate-x-1/2 overflow-y-hidden text-center text-5xl font-bold sm:text-6xl md:left-0 md:w-auto md:translate-x-0 md:text-left md:text-7xl xl:text-8xl">
          <span class="letters inline-block text-dph-orange">Create</span>
        </h1>
        <h1
          id="indexText3" class="split-text absolute left-1/2 inline-block w-full -translate-x-1/2 overflow-y-hidden text-center text-5xl font-bold sm:text-6xl md:left-0 md:w-auto md:translate-x-0 md:text-left md:text-7xl xl:text-8xl">
          <span class="letters inline-block text-dph-orange">Play</span>
        </h1>
      </div>
      <h2 class="w-full text-center text-xl text-slate-950 dark:text-slate-100 sm:text-xl md:w-auto md:text-left md:text-2xl xl:text-3xl">
        Over <span
          title="{(data.count - 1).toString()}" class="text-gradient bg-gradient-to-br from-rose-500 to-yellow-500 font-bold">
          {compactNumberFormatter.format(data.count - 1)}
        </span>
        of the latest and best datapacks from creators across the globe
      </h2>
    </div>
    <div class="mt-8 h-fit justify-between space-y-3 overflow-x-clip overflow-y-auto rounded-xl px-4 sm:my-16 md:my-0 md:w-1/2">
      <h3 class=" text-2xl font-medium text-slate-950 dark:text-slate-100 text-center mt-6">
        Featured Projects
      </h3>
  ...
  <div class="w-full bg-slate-200 dark:bg-stone-800/20 py-48 flex flex-col justify-center items-center ">
    <h1 class="fadeTextAnime text-black dark:text-white text-center text-4xl lg:text-5xl xl:text-6xl mx-4">
      The Go-To Platform for Datapacks
    </h1>
    <div class="mt-6 grid grid-cols-2 w-3/4 xl:w-2/3 2xl:w-1/2 gap-3">
      <div class="p-4 row-span-2 bg-slate-300 dark:bg-stone-800 rounded-lg w-full">
        <h2 class="opacity-0 fadeTextAnime text-black dark:text-white text-lg lg:text-xl xl:text-2xl">
        ...
        <div class="bg-slate-200 dark:bg-stone-900 rounded-lg p-4">
          <div class="flex items-center justify-between bg-slate-300 dark:bg-stone-800 rounded-t-md p-2 mx-4 mt-4 text-slate-600 dark:text-stone-500">
            <p>pack.mcmeta</p>
            <IconX />
          </div>
          <div class="text-slate-600 dark:text-stone-500 font-mono bg-slate-300 dark:bg-stone-800 mx-4 mb-4 my-2 px-4 rounded-b-md overflow-x-auto">
            <pre class="text-sm">
              <!--DO NOT INDENT!!!-->
&lbrace;
  "pack": &lbrace;
    "pack_format": <span class="text-red-500">10</span> -&gt; <span class="text-green-500 fadeTextAnime">15</span
              >,
...
&rbrace;
          ...
          {#each data.staff as staff, i}
            <a href="/user/{staff.username}">
              <img
                ...
                loading="lazy" class="lg:h-12 rounded-md hover:scale-105 transition-all fadeTextAnime"/>
            </a>
          {/each}
        </div>
      </div>
      <div class="p-4 bg-slate-300 dark:bg-stone-800 rounded-lg w-full">
        ...
        <a class="rounded-lg p-2 bg-[#5865F2] text-white font-bold"
          href="https://discord.gg/aEXsdjjdu4">
          <img
            src="/logos/discord-white.svg"
            alt="discord logo" class="inline-block mr-2"
            height="16"
      ...
      <div class="p-4 bg-slate-300 dark:bg-stone-800 rounded-lg w-full">
        ...
        <p class="fadeTextAnime text-black dark:text-white text-lg my-4 font-light">
          We use PackSquash in the background to reduce the size of files and make them run faster in-game!
        </p>
