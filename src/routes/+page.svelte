...
<body class="dark dark:bg-stone-900 bg-newWhite h-screen">
	<Navbar />
	{#if visible}
		<div class="flex flex-col items-center justify-center h-screen w-screen">
			...
			<p
				class="dark:text-newWhite text-black w-2/3 md:w-1/2 lg:w-1/3 mt-8 text-center sm:text-2xl md:text-3xl lg:text-4xl"
			>
				Over <span
					title={rand.toString()}
			...
			<div class="flex w-2/3 md:w-1/2 lg:w-1/3r items-center justify-evenly mt-8 md:mt-16">
