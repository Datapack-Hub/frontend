...
<main
  ...
  <section
    ...
    <a
      href="#features"
      class="fixed bottom-24 z-50 rounded-full bg-slate-200 px-2 py-1 shadow-lg dark:bg-zinc-700 dark:text-white lg:bottom-4 {scrollY >
      100
        ? 'opacity-0'
...
&rbrace;
      ...
      <div
        ...
        <a
          class="button-base flex items-center justify-center gap-3 bg-[#5865F2] font-bold text-white"
