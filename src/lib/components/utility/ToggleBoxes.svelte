...
<div
  ...
  class="{clicked
    ...
    : 'hover:border-dph-orange dark:hover:border-dph-orange border-slate-400 bg-slate-300 dark:border-stone-700 dark:bg-stone-800'} border-2 p-2 rounded-lg text-slate-950 dark:text-slate-100 select-none cursor-pointer transition-all"
