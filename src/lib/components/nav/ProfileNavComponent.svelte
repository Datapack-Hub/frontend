  ...
  {#if $authed}
    {#if moderatorOrAbove($roleInfo) && !small}
      <a
        ...
        class="z-20 mr-2 hover:brightness-75 md:mr-6"
    ...
    {#if !small}
      <a
        ...
        class="z-20 ml-2 hover:brightness-75 md:ml-6"
    ...
    <a
      ...
      <img
        ...
        height="24"
        width="24"
        class="ml-3 rounded-full outline outline-2 outline-offset-2 hover:brightness-75 md:ml-6"
