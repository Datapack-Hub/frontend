  ...
  <nav
    ...
    <ConditionalWrapper
      ...
      <div
        ...
        class="rounded-full p-1 dark:text-zinc-100 md:hidden md:hover:bg-transparent md:active:brightness-75">
        <IconWrench width="24" height="24" />
        {#if showToolsPanel}
          <div
            transition:fade="{{ duration: 100 }}"
            class="grid-first-small absolute -top-48 left-0 grid w-full gap-3 rounded-md bg-slate-50 px-6 py-3 shadow-lg transition-all dark:bg-zinc-950 dark:text-white md:top-12">
            <div class="flex items-center">
      ...
      {#if $authed}
        <a
          ...
          {#if showUserPanel}
            <div
              transition:fade="{{ duration: 100 }}"
              class="grid-first-small absolute -top-32 right-4 grid gap-3 rounded-md bg-slate-50 px-6 py-3 shadow-lg transition-all dark:bg-zinc-950 dark:text-white md:top-12">
              <a
                href="/user/{$user.username}"
