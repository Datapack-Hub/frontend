    ...
    <div class="flex items-center">
      <a href="/" class="z-20 flex cursor-pointer items-center">
        <img
          ...
          width="32" />
        <span
          class="hidden font-brand text-2xl font-bold transition-colors hover:text-neutral-700 active:text-neutral-600 text-pearl-lusta-950 dark:text-white dark:hover:text-neutral-400 dark:active:text-neutral-500 md:block">
          Datapack Hub
        </span>
      </a>
      {#if showNavItems}
        {#if innerWidth > 768}
          <a
            href="/projects"
            class="z-20 pl-6 font-brand text-lg font-light transition-colors hover:text-neutral-700 active:text-neutral-600 text-pearl-lusta-950 dark:text-white dark:hover:text-neutral-400 dark:active:text-neutral-500">
            Explore
          </a>
          <a
            href="/"
            target="_self"
            class="z-20 pl-4 font-brand text-lg font-light transition-colors hover:text-neutral-700 active:text-neutral-600 text-pearl-lusta-950 dark:text-white dark:hover:text-neutral-400 dark:active:text-neutral-500">
            Learn
          </a>
          <a
            href="/"
        ...
        {:else}
          <a
            ...
            class="z-20 pl-3 font-brand text-lg font-light transition-colors hover:text-neutral-700 active:text-neutral-600 text-pearl-lusta-950 dark:text-white dark:hover:text-neutral-400 dark:active:text-neutral-500 md:pl-6">
            <IconCompass
              height="24"
              width="24"
