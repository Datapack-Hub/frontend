...
<div
  class="prose-tbody:odd:bg-zinc-600 prose break-words leading-snug dark:prose-invert prose-img:py-3 prose-a:break-all prose-code:before:content-none prose-code:after:content-none prose-table:rounded-md prose-table:bg-slate-300 prose-th:p-3 prose-td:p-3 prose-table:dark:bg-zinc-800 prose-p:my-4 {classes}">
